...
VALUES ('admin', 'admin@123km.com', '$2a$10$rJoOYTeehRm6Gy.74nlUXeMdQWB00ILCKTNxcnyPu3B7lFr97IAy.', 'Administrador');

-- admin ao usuário admin
...
SELECT id, amenity
FROM hotels h,
UNNEST(ARRAY['Piscina', 'Academia', 'Spa', 'Restaurante', 'Bar', 'Wi-Fi', 'Estacionamento', 'Serviço de Quarto 24h']) amenity
